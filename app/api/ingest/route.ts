...
async function seedSources() {
  const sources = [
    ...
    { id: 'bbc-sport', name: 'BBC Sport', url: 'https://www.bbc.com/sport', feedUrl: 'https://feeds.bbci.co.uk/sport/rss.xml', ingestStrategy: 'rss', lang: 'en', tier: 'tier-1', editorialIndependence: 'independent', isWireService: false, contentKind: 'sports', weight: 0.9, isActive: true },
    ...
    { id: 'stereogum', name: 'Stereogum', url: 'https://www.stereogum.com', feedUrl: null, ingestStrategy: 'rss', lang: 'en', tier: 'tier-2', editorialIndependence: 'independent', isWireService: false, contentKind: 'music', weight: 0.75, isActive: true },
